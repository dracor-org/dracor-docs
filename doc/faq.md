...
To easily sort plays chronologically, e.g., for a corpus overview or diagrams, we also calculate a »Normalised Year«. This year is usually the earlier date of the date of first printing and the year of first performance.
